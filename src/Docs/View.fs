        ...
        Html.aside [
            ...
            prop.children [
                Html.divClassed
                    ...
                    [ Html.span [
                          color.textPrimary
                          prop.text "Feliz.Konva"
                      ]
                      Html.a [
                          prop.href "https://www.nuget.org/packages/Feliz.Konva"
                          prop.children [
                              Html.img [
                                  prop.src "https://img.shields.io/nuget/v/Feliz.Konva.svg?style=flat-square"
                              ]
                          ]
                      ] ]
                Daisy.menu [
...
let AppView (state: State) (dispatch: Msg -> unit) =
    ...
    let title, docLink, content =
        ...
        | Circle -> "Circle", "/Circle", Pages.CircleView.CircleView()
